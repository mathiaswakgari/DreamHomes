                ...
                <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                    ...
                    <div class="px-9 pt-5 flex justify-between items-stretch flex-wrap min-h-[70px] pb-0 bg-transparent">
                        <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                            ...
                            <span class="mt-1 font-medium text-secondary-dark text-lg/normal">All users from the database</span>
                        </h3>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full my-0 align-middle text-dark border-neutral-200">
                                ...
                                <tr class="font-semibold text-[0.95rem] text-secondary-dark">
                                    <th class="pb-3 text-start min-w-[50px]">PROFILE</th>
                                    <th class="pb-3 text-end min-w-[10px]">ID</th>
                                    <th class="pb-3 text-end min-w-[100px]">FIRSTNAME</th>
                                    <th class="pb-3 pr-12 text-end min-w-[175px]">LASTNAME</th>
                                    <th class="pb-3 pr-12 text-end max-w-[100px]">EMAIL</th>
                                    ...
                                    <td class="p-3 pl-0">
                                        <div class="flex items-center">
                                            <div class="relative inline-block shrink-0 rounded-2xl me-3">
                                                <img src="<%=user.getUser_profile_picture()%>" class="w-[50px] h-[50px] inline-block shrink-0 rounded-2xl" alt="">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-3 pr-0 text-end">
                                        <span class="font-semibold text-light-inverse text-md/normal"><%=user.getUser_id()%></span>
                                    </td>
                                    <td class="p-3 pr-0 text-end">
                    <span class="text-center align-baseline inline-flex px-2 py-1 mr-auto items-center font-semibold text-base/none text-success bg-success-light rounded-lg">
                       <%=user.getUser_firstname()%> </span>
                                    </td>
                                    <td class="p-3 pr-12 text-end">
                                        <span class="text-center align-baseline inline-flex px-4 py-3 mr-auto items-center font-semibold text-[.95rem] leading-none text-primary bg-primary-light rounded-lg"> <%=user.getUser_lastname()%> </span>
                                    </td>
                                    <td class="pr-0 text-start">
                                        <span class="font-normal text-light-inverse text-sm text-gray-500"><%=user.getUser_email()%></span>
                                    </td>
                                    <td class="p-3 pr-0 text-end">
                                        <a href="delete_user?user_id=<%=user.getUser_id()%>">
