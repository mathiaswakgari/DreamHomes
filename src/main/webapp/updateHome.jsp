...
<html>
<head>
    <title>Dream Homes : Update Home, <%=home.getAddress().getAddress1()%></title>
...
<div class="w-full h-full mt-16">
    <p class="text-2xl m-3 p-3 font-normal text-center">UPDATE HOME, <%=home.getAddress().getAddress1()%>.</p>
    <form enctype="multipart/form-data" method="post" action="updateHome?home_id=<%=home.getHomeId()%>&&address_id=<%=home.getAddressId()%>" class=" flex gap-y-[75px] flex-col mt-1 p-3  h-full w-full rounded-b-lg">
            ...
            <div>
                <div class="">
                    ...
                    <div class="mt-2">
                        <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                            <input min="1" value="<%=home.getHomePrice()%>" required type="number" step="0.01"  name="price" id="price" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6" placeholder="$340,000.87">
                        </div>
                    </div>
                </div>
                <div class=" flex">
                    <div class="w-1/2 pr-1">
                        ...
                        <div class="mt-2">
                            <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input min="1" value="<%=home.getBedNumber()%>" required type="number"  name="bed" id="bed" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6" placeholder="2">
                            </div>
                        </div>
                    </div><div class="w-1/2">
                    ...
                    <div class="mt-2">
                        <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                            <input min="1" value="<%=home.getBathNumber()%>" required type="number"  name="bath" id="bath" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6" placeholder="2">
                        </div>
                    </div>
                </div>
                </div>
                <div class="flex">
                    <div class="w-1/2 pr-1">
                        ...
                        <div class="mt-2">
                            <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input min="1" value="<%=home.getHomeArea()%>" required type="number" step="0.01"  name="area" id="area" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6" placeholder="200">
                            </div>
                        </div>
                    </div><div class="w-1/2">
                    ...
                    <div class="mt-2">
                        <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                            <input required min="1000" max="2024" value="<%=home.getYearBuilt()%>" type="number" name="year " id="year" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6" placeholder="2015">
                        </div>
                    </div>
                </div>
                </div>
            ...
            <div class="w-full flex flex-col">
                <div class="pr-1 w-full">
                    ...
                    <div class="mt-2 w-full">
                        <div class="w-full flex justify-center shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                            <textarea required  name="utilities" id="utilities" class="w-full min-h-15 max-h-28 h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6"><%=home.getHomeUtilities()%></textarea>
                        </div>
                    </div>
                ...
                <div class="mt-2 w-full">
                    <div class="w-full flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        <textarea required  name="about" id="about" class="min-h-48 max-h-72 w-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6"><%=home.getHomeAbout()%></textarea>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="grid w-full grid-cols-2 mt-5">
                <div class="grid w-full grid-cols-2">
                    <div class=" pr-1">
                        ...
                        <div class="mt-2">
                            <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input value="<%=home.getAddress().getAddress1()%>" required type="text"  name="address_1" id="address_1" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                    <div class=" pr-1">
                        ...
                        <div class="mt-2">
                            <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input value="<%=home.getAddress().getAddress2()%>" type="text"  name="address_2" id="address_2" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                    <div class=" pr-1">
                        ...
                        <div class="mt-2">
                            <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input type="text" value="<%=home.getAddress().getAddress3()%>"  name="address_3" id="address_3" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-2">
                    <div class=" pr-1">
                        ...
                        <div class="mt-2">
                            <select required id="city"  name="city" class="bg-gray-200 opacity-90 border border-gray-300 text-gray-900 text-sm w-full  rounded-l-md p-2.5">
                    ...
                    <div class=" pr-1">
                        ...
                        <div class="mt-2">
                            <select required id="state" name="state" class="bg-gray-200 opacity-90 border border-gray-300 text-gray-900 text-sm w-full  rounded-l-md p-2.5">
                    ...
                    <div class=" pr-1">
                        ...
                        <div class="mt-2">
                            <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input value="<%=home.getAddress().getPostalCode()%>" min="1" required type="number"  name="postal" id="postal" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
        ...
        <div class="w-full">
            ...
            <div class="flex mt-5 w-full">
                <div class="w-full pr-1">
                    ...
                    <div class="mt-2 w-full">
                        <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                            <input value="<%=home.getAgentName()%>" required type="text"  name="agent_name" id="agent_name" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6">
                        </div>
                    </div>
                </div>
                <div class="w-full pr-1">
                    ...
                    <div class="mt-2">
                        <div class="rounded-sm flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                            <input value="<%=home.getAgentNumber()%>" required type="text"  name="agent_number" id="agent_number" class="rounded-full h-12 block flex-1 border-0 bg-transparent py-1.5 pl-4 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6">
                        </div>
                    </div>
                </div>
            </div>
