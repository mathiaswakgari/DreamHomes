...
<html>
<head>
    <title>Dream Homes: <%=request.getSession().getAttribute("user_fullname")%></title>
            ...
            <div class="pt-20 px-4 w-full flex-col justify-center items-center">
                    ...
                    <div class="w-full mr-2">
                        ...
                        <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-2xl">
                                <input required type="text"  name="firstname" id="firstname" autocomplete="firstname" class="h-12 block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                    <div class="w-full">
                        ...
                        <div class="mt-2">
                            <div class="h-12 flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-2xl">
                                <input required type="text"  name="lastname" id="lastname" autocomplete="lastname" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 focus:outline-none sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full mt-8 flex items-center">
                    <div class="w-full mr-2">
                        ...
                        <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-2xl">
                                <input required type="email"  name="email" id="email" autocomplete="email" class="h-12 block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    </div>
                    <div class="w-full">
